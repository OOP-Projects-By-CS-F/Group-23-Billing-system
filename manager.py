...
class login_page:
    ...
    def login(self, Event=None):
        ...
        if results:
            if results[0][6]=="manager" or "Manager":
...
def about():
    ...
    global about_us
    about_us=Toplevel()
    about_us.geometry("1366x768")
    label1 = Label(about_us)
    label1.place(relx=0, rely=0, width=1366, height=768)
    img = PhotoImage(file="./images/about_us.png")
    label1.configure(image=img)
    about_us.protocol("WM_DELETE_WINDOW",exit)
    about_us.mainloop()
